    ...
    >
      <div className="w-full lg:px-[50px]">
        <div className={`${Styles["form-box"]} flex flex-col justify-center items-center m-auto`}>
          <h1 className="text-[30px] font-bold text-[#ff6b07] mb-2">
            TempleAddress
          </h1>
          <h2 className="text-[30px] font-bold text-[#000] mb-2">Register</h2>
        </div>
        <form action="" className="px-5" >
          <div className="mb-2 font-semibold">
            ...
            <input
              type="text"
              className="w-full py-3 pl-4 outline-none border-[#000] text-[#000] rounded-[6px] mt-1"
