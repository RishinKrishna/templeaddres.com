...
const Articles = () => {
  return (
    <>
      <h2 className="text-[#ff6b07] font-semibold text-[25px] ml-4 lg:mt-10 mt-5">
        Latest Articles
      </h2>
      <div
        className={`${Styles["articles_container"]} grid mt-3 lg:pb-[100px] pb-10`}
      >
        {serviceCard.map(({ id, image, description }, index) => {
          return (
            ...
            >
              ...
              <Link
                href=""
                className="font-semibold px-6 pb-5 text-[#ff6b07] items-end"
              >
                view more
              </Link>
            </div>
