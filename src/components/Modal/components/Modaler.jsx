...
const Modaler = ({ setShow, maxWidth, component, header, containerClassName, modalBodyClassName }) => {
    const closeModal = () => {
        setShow(false)
    ...
    return (
        <>
            ...
            <div
                className={classNames(`${Styles['layout-container']} `, containerClassName)}
            ...
            >
                ...
                <div className={classNames(Styles['modal-body'], modalBodyClassName)}>
                    {typeof component === "function" ? component({ closeModal }) : component}
                </div>
            </div>
        </>
    )
